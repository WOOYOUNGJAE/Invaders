...
public class EnemyShipFormation implements Iterable<EnemyShip> {
	...
	private static final int SEPARATION_DISTANCE = 40*Core.sizingNum; // update
	...
	private static final int X_SPEED = 8*Core.sizingNum;	//enemy speed update
	/** Downwards speed of the formation. */
	private static final int Y_SPEED = 4*Core.sizingNum;	//enemy speed update
